...
namespace ML.EmotionDemo
{
    public partial class frmMainAdvanced : Form
    {
        ...
        private void btnBuildModel_Click(object sender, EventArgs e)
        {
            ...
            //bool ret = emotionEngine.BuildAndTrainModel(trainerType, new string[] { "Text","Stars" }, "EmotionLabel");
            string msg = "";
            if (ret)
        ...
        private void btnEvaluateModel_Click(object sender, EventArgs e)
        {
            ...
            txtAccuracy.Text = String.Format("{0:0.0000}", metric.Accuracy);
            txtF1Compliment.Text= String.Format("{0:0.0000}", metric.F1_Score_Compliment);
            txtF1Neutral.Text= String.Format("{0:0.0000}", metric.F1_Score_Neutral);
            txtF1Blame.Text = String.Format("{0:0.0000}", metric.F1_Score_Blame);
        ...
        private void btnPredict_Click(object sender, EventArgs e)
        {
            ...
            feedback.Text=txtInputData.Text.TextCleaning();
            feedback.Stars = getStar();
